...
#define MOUSEKEY_WHEEL_INTERVAL 40 // Increase time between scroll steps (default is 80)
...
#define MOUSEKEY_WHEEL_TIME_TO_MAX 20 // Make it take longer to reach max speed (default is 40)
